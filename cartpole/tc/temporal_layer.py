...
class TemporalLayer(nn.Linear):
    ...
    def forward(self, input):
        ...
        for k in range(input_size):
            ...
            #print(numerator.shape, square.shape, denominator.shape, root.shape)
            ...
            #print(contribution_mask.shape, infinity_spikes.shape, contributionPoint.shape)
            outputTimes = outputTimes_all[np.arange(self.out_features), contributionPoint]
            #print(sortedSpikeIndices, cumulativeWeights, numerator, infinity_spikes, "\n\n")
